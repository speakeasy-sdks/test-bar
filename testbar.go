...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/speakeasy-sdks/test-bar/internal/hooks"
...
// TestBar - The Speakeasy Bar: A bar that serves drinks.
...
type SDKOption func(*TestBar)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *TestBar) {
...
func New(opts ...SDKOption) *TestBar {
	sdk := &TestBar{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "0.11.1",
			GenVersion:        "2.272.7",
			UserAgent:         "speakeasy-sdk/go 0.11.1 2.272.7 1.0.0 github.com/speakeasy-sdks/test-bar",
			ServerDefaults: map[string]map[string]string{
				"prod":    {},
				"staging": {},
				"customer": {
